              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-gray-400 font-mono">
                    {formatAddress ? formatAddress(walletAddress) : truncateAddress(walletAddress)}
                  </div>
                </div>
              </button>
              {showProfilePopup && (
                ...
                >
                  ...
                  <button
                    ...
                    className="block w-full py-2 bg-emerald-500 rounded-lg text-black font-medium hover:bg-emerald-600 transition-colors"
                  >
                    Close
                  </button>
                </div>
